...
if os.path.basename(sys.argv[0]) != "Black_Hole_38.py":

    sys.exit("This is not 'Black_Hole_38.py'.")


print("The script 'Black_Hole_38.py' is currently running.")
                        ...
                        if i == 1:
                            ...
                            if Ex == 1:
                                ...
                                while Find != 1:
                                    ...
                                    if Find == 2 or Row == 801:

                                        Find = 1

                                        Extract1 = 1

                                    elif Row == 800 and Find == 3:
